...
```{r}
# Crear el boxplot para comparar la variable Murder según las dos categorías de UrbanPop
ggplot(USArrests, aes(x = UrbanPop_cat, y = Murder, fill = UrbanPop_cat)) +
  geom_boxplot(show.legend = FALSE) +  # Eliminar la leyenda
  ...
  theme_minimal()
```
Con este box plot confirmamos que la media de las zonas rurales es mayor que en las urbanas y que los datos están más dispersos en la población rural.
